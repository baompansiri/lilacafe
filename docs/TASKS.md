...
| 0.33 | Verify v3: drag-and-drop upload + confirm modal | done | ลากไฟล์วางบน card → preview modal → Enter ยืนยัน / Esc ยกเลิก; visual highlight target card ขณะลาก |
...
| 2026-06-10 | หน้าแรกจำกัด "Signature & Favorites" เหลือ 2 แถว (8 การ์ดเดสก์ท็อป / 4 มือถือ) คละหมวดแบบ round-robin |
| 2026-06-10 | **Deploy:** commit งานทั้งหมด (f1c5f8e) → PR #1 merge เข้า main → เปิด GitHub Pages (main/root) → live ที่ baompansiri.github.io/lilacafe |
| 2026-06-10 | **Restructure for clean URL:** ย้ายไฟล์แอปจาก lilacafe/ → repo root (แก้ ../assets → assets), ลบหน้า redirect → URL เป็น baompansiri.github.io/lilacafe/ ตรงๆ (PR #2, ccf8b00) |
| 2026-06-10 | **Mobile responsive audit/fix (คงโทนเดิม):** แก้ horizontal scroll หน้าแรก (map iframe aspect-ratio+min-h ดันจอ → fixed height + w-full), bump touch target chips/CTA เป็น 44px ทุกหน้า, เพิ่ม prefers-reduced-motion support (index/menu/facility). ตรวจ 375px: ทุกหน้า overflow=0 |
